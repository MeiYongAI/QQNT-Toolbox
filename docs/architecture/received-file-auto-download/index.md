...
- QQ 原生路径只作为取得内容的来源，验证后写入插件账号级 staging；撤回时从 staging 晋升到归档。
...
5. 发送方撤回后，staging 文件晋升到持久归档，防撤回恢复的文件消息能打开该归档文件。
6. 重启 QQ 后，防撤回记录直接使用插件归档路径；QQ 原生下载路径和 QQ 缓存均不承担长期保留职责。
